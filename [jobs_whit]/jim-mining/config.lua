...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['emerald_ring_silver'] = 1070,
		['ruby_ring_silver'] = 1080,
		['sapphire_ring_silver'] = 1000,

		['diamond_necklace'] = 1200,
		['emerald_necklace'] = 1100,
		['ruby_necklace'] = 1200,
		['sapphire_necklace'] = 1100,
		['diamond_necklace_silver'] = 1200,
		['emerald_necklace_silver'] = 1100,
		['ruby_necklace_silver'] = 1200,
		['sapphire_necklace_silver'] = 1400,

		['diamond_earring'] = 1300,
		['emerald_earring'] = 1400,
		['ruby_earring'] = 1500,
		['sapphire_earring'] = 1100,
		['diamond_earring_silver'] = 1400,
...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "water_bottle", price = 3, amount = 100, info = {}, type = "item", slot = 1, },
