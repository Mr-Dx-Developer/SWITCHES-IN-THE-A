...
if isResourceLoaded('qs-inventory') then
    SetTimeout(1000, function()
        AssetDeployer:registerCopyFilesDeploy('items-images', shared.framework == 'ESX' and 'qs-inventory' or shared.framework == 'QBCORE' and 'shared/items.lua', 'assets/inventoryImages', 'html/images',
            function(data)
                local files = {}
