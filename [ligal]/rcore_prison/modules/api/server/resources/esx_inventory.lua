...
if isResourceLoaded('es_extended') and not isResourceLoaded('ox_inventory') and not isResourceLoaded('qs-inventory') then
    AssetDeployer:registerDeploy('items', 'es_extended', function(data)
