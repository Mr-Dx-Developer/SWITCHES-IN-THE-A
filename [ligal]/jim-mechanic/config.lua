Config = {
	...
	Main = { -- Main variables
		...
		JobRoles = { "mechanic", "ricocustom", "bigvroycustoms", "bandoscustom", "vroyluxury", "slatlanta", "famgooncustoms", "eastcustom" }, -- These are the job roles who can use items if RequiresJob is enabled.
