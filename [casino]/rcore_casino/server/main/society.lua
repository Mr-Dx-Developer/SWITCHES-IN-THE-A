...
function RemoveMoneyFromSociety(money)
    ...
    elseif Config.SocietyFramework == "addon_account_data" then
        ...
        return
    elseif Config.SocietyFramework == "qb-banking" then
        QBBanking_RemoveMoney(money)
        return
    end
