...
CreateThread(function()
	local lunaticstudio_promo001_beds = {
		{
			...
			['price'] = 1450,
			['label'] = 'Quasar Bed A',
			['background'] = 'rgba(16, 169, 230, 0.17)',
			['group_items'] = {
	...
	insertFurniture(Config.FurnitureList.beds, lunaticstudio_promo001_beds)
	insertFurniture(Config.FurnitureList.sideboards, lunaticstudio_promo001_sideboards)
	insertFurniture(Config.FurnitureList.tables, lunaticstudio_promo001_tables)
	insertFurniture(Config.FurnitureList.sofas, lunaticstudio_promo001_sofas)
	insertFurniture(Config.FurnitureList.electronics, lunaticstudio_promo001_electronics)
end)
