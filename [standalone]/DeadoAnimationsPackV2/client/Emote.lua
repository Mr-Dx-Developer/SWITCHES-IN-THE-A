...
function EmoteMenuStart(args, hard)
    ...
    elseif etype == "whitecustom4" then
        if DP.White4ro[name] ~= nil then
            if OnEmotePlay(DP.White4ro[name]) then end
        end
    elseif etype == "whitecustom5" then
        if DP.White5ro[name] ~= nil then
            if OnEmotePlay(DP.White5ro[name]) then end
        end
