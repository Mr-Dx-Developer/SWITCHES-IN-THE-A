...
Config.Debug = true -- this will print everything on client/server
...
--Framework
Config.ESX = true
Config.UsingNewExportTriggerEvent = true -- false if you still using old shit TriggerEvent('esx:getSharedObject', function(obj) ESX = obj end)
Config.TriggerEventESX = 'esx:getSharedObject' -- Default one
Config.TriggerEventPlayerSpawn = 'esx:onPlayerSpawn' -- esx:onPlayerSpawn (newest esx) / playerSpawned (old shit esx)
...
Config.SkinChanger = false --Did you use Skin Changer and esx_skin? // false if you using fivem-appearance
...
Config.ChancePregnant = 100 -- Random from 1 to Config.MaxChancePregnant, so for example it'll 10%
...
Config.FadeOutInDuration = 1000 -- ms, duration per scene
Config.SexDuration = 1000 -- ms, duration per scene
...
Strings = {
    ...
    ['text_childbirth'] = '~INPUT_CONTEXT~ Child Birth',
