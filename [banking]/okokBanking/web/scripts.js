		...
		case 'transactions_page':
			...
			for(var i = 0; i < num; i++) {
				...
				if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
					icon = '<td class="align-middle"><span style="background-color: #1f2f29; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								From <span style="color: #249093; font-weight: 600;">${db.sender_name}</span>
				...
				// Sent
					...
					icon = '<td class="align-middle"><span style="background-color: #1f2f29; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								To <span style="color: #249093; font-weight: 600;">${db.receiver_name}</span>
				...
				// Deposited
					...
					icon = '<td class="align-middle"><span style="background-color: #1f2f29; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								Into <span style="color: #249093; font-weight: 600;">${db.receiver_name}</span>
			...
			$('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #249093; border-radius: 10px; color: #fff;">
				...
				<table id="transactionsTable">
					<tbody id="transactionsData">
						<tr>
							<td class="align-middle"><span style="background-color: #1f2f29; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								To <span style="color: #249093;">Arthur James</span>
								<div style="margin-top: -5px;">Sent</div>
							</td>
						...
						<tr>
							<td class="align-middle"><span style="background-color: #1f2f29; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Into <span style="color: #249093;">Bank Account</span>
								<div style="margin-top: -5px;">Deposited</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
...
function overview_page_function(event) {
	...
	$('#page_info').html(`
		<div class="col-md-7" style="border-right: 1px solid rgba(62, 63, 75);">
			<div class="card text-center" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				<div class="card-header" style="background-color: #286758; border-top-right-radius: 10px; border-top-left-radius: 10px;">
					<span style="color: #fff; font-size: 18px;"><i class="fas fa-chart-line"></i> Statistics</span>
				</div>
				<div class="card-body" style="background-color: #1f2f29; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card h-100" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75); margin-top: 12px;">
						<div class="card-header text-center" style="background-color: #286758; border-top-right-radius: 10px; border-top-left-radius: 10px;">
						...
						<div class="card-body" style="background-color: #1f2f29; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; padding: 0.6rem 1rem;">
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1f2f29; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #249093;">Arthur James</span>
											<div style="margin-top: -5px;">Received</div>
										</td>
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1f2f29; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #249093;">Bank Account</span>
											<div style="margin-top: -5px;">Withdrawn</div>
										</td>
		...
		<div class="col-md-5">
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					...
					<div class="card-body" style="background-color: #1f2f29; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
	...
	for(var i = 0; i < num; i++) {
		...
		// Received
		if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
			icon = '<td class="align-middle"><span style="background-color: #1f2f29; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
		...
		// Sent
			...
			icon = '<td class="align-middle"><span style="background-color: #1f2f29; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
			data = `<td class="align-middle" style="font-weight: 500; font-size: 16px;">
						To <span style="color: #249093; font-weight: 600;">${db.receiver_name}</span>
						<div style="margin-top: -5px;">Sent</div>
					</td>`;
	...
	$('#page_info').html(`
		<div class="col-md-12 d-flex flex-grow-1 flex-column h-100" style="flex: 1 1 50%;">
			<div class="card d-flex flex-column flex-grow-1" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
				...
				<div class="card-body flex-grow-1" style="background-color: #1f2f29; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
					<div class="">
						<div class="row">
							<div class="col col-md-6 d-flex justify-content-center">
								<div class="card w-100 h-100" style="background-color: #286758; border-radius: 10px; color: #fff;">
								  <div class="card-body text-center">
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #249093; border-radius: 10px; color: #fff;">
