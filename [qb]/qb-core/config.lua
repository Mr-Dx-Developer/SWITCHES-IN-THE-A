...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 2048) -- Gets max players from config file, default 48
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 500, bank = 200000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
