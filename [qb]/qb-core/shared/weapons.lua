...
QBShared.Weapons = {
	...
	[`weapon_nvifle_purple`]	= {['name'] = 'weapon_nvifle_purple',	['label'] = 'NV Rifle Purple Gang',	['weapontype'] = 'Assault Rifle',	['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},
