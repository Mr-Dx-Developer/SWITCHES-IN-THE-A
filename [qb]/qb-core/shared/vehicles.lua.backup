...
local Vehicles = {
    ...
    { model = 'blista',        name = 'Blista',                        brand = 'Dinka',           price = 55000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso',        name = 'Brioso R/A',                    brand = 'Grotti',          price = 59000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'club',          name = 'Club',                          brand = 'BF',              price = 40000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'dilettante',    name = 'Dilettante',                    brand = 'Karin',           price = 20000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'dilettante2',   name = 'Dilettante Patrol',             brand = 'Karin',           price = 21000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'kanjo',         name = 'Blista Kanjo',                  brand = 'Dinka',           price = 85000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi2',         name = 'Issi',                          brand = 'Weeny',           price = 14000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi3',         name = 'Issi Classic',                  brand = 'Weeny',           price = 40000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi4',         name = 'Issi Arena',                    brand = 'Weeny',           price = 50000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi5',         name = 'Issi Future Shock',             brand = 'Weeny',           price = 60000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi6',         name = 'Issi Nightmare',                brand = 'Weeny',           price = 70000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'panto',         name = 'Panto',                         brand = 'Benefactor',      price = 9000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'prairie',       name = 'Prairie',                       brand = 'Bollokan',        price = 21000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'rhapsody',      name = 'Rhapsody',                      brand = 'Declasse',        price = 57000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'brioso2',       name = 'Brioso 300',                    brand = 'Grotti',          price = 40000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'weevil',        name = 'Weevil',                        brand = 'BF',              price = 39000,    category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'issi7',         name = 'Issi Sport',                    brand = 'Weeny',           price = 80000,  category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'blista2',       name = 'Blista Compact',                brand = 'Dinka',           price = 110050,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'blista3',       name = 'Blista Go Go Monkey',           brand = 'Dinka',           price = 130050,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'boor',          name = 'Boor',                          brand = 'Karin',           price = 20000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    --- Sedans (1)
    ...
    { model = 'cog55',         name = 'Cognoscenti 55',                brand = 'Enus',            price = 96000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'cognoscenti',   name = 'Cognoscenti',                   brand = 'Enus',            price = 98000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'emperor',       name = 'Emperor',                       brand = 'Albany',          price = 55050,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'fugitive',      name = 'Fugitive',                      brand = 'Cheval',          price = 81000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'glendale',      name = 'Glendale',                      brand = 'Benefactor',      price = 73400,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'glendale2',     name = 'Glendale Custom',               brand = 'Benefactor',      price = 74400,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'ingot',         name = 'Ingot',                         brand = 'Vulcar',          price = 70999,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'intruder',      name = 'Intruder',                      brand = 'Karin',           price = 68050,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'premier',       name = 'Premier',                       brand = 'Declasse',        price = 82000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'primo',         name = 'Primo',                         brand = 'Albany',          price = 69000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'primo2',        name = 'Primo Custom',                  brand = 'Albany',          price = 70000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'regina',        name = 'Regina',                        brand = 'Dundreary',       price = 78000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stafford',      name = 'Stafford',                      brand = 'Enus',            price = 221000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stanier',       name = 'Stanier',                       brand = 'Vapid',           price = 91000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stratum',       name = 'Stratum',                       brand = 'Zirconium',       price = 95090,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'stretch',       name = 'Stretch',                       brand = 'Dundreary',       price = 19000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'superd',        name = 'Super Diamond',                 brand = 'Enus',            price = 119000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'surge',         name = 'Surge',                         brand = 'Cheval',          price = 120000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'tailgater',     name = 'Tailgater',                     brand = 'Obey',            price = 113000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'warrener',      name = 'Warrener',                      brand = 'Vulcar',          price = 84900,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'washington',    name = 'Washington',                    brand = 'Albany',          price = 127000,    category = 'sedans',         type = 'automobile', shop = 'pdm' },
    ...
    --- SUV (2)
    { model = 'baller',        name = 'Baller',                        brand = 'Gallivanter',     price = 145000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller2',       name = 'Baller II',                     brand = 'Gallivanter',     price = 155000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller3',       name = 'Baller LE',                     brand = 'Gallivanter',     price = 165000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller4',       name = 'Baller LE LWB',                 brand = 'Gallivanter',     price = 175000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller5',       name = 'Baller LE (Armored)',           brand = 'Gallivanter',     price = 185000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'baller6',       name = 'Baller LE LWB (Armored)',       brand = 'Gallivanter',     price = 195000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'bjxl',          name = 'BeeJay XL',                     brand = 'Karin',           price = 82000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'cavalcade',     name = 'Cavalcade',                     brand = 'Albany',          price = 75000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'cavalcade2',    name = 'Cavalcade II',                  brand = 'Albany',          price = 76000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'contender',     name = 'Contender',                     brand = 'Vapid',           price = 200000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'dubsta',        name = 'Dubsta',                        brand = 'Benefactor',      price = 150000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'dubsta2',       name = 'Dubsta Luxury',                 brand = 'Benefactor',      price = 160000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'fq2',           name = 'FQ2',                           brand = 'Fathom',          price = 130500,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'granger',       name = 'Granger',                       brand = 'Declasse',        price = 220000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'gresley',       name = 'Gresley',                       brand = 'Bravado',         price = 150000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'habanero',      name = 'Habanero',                      brand = 'Emperor',         price = 105000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'huntley',       name = 'Huntley S',                     brand = 'Enus',            price = 106500,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'landstalker',   name = 'Landstalker',                   brand = 'Dundreary',       price = 60000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'landstalker2',  name = 'Landstalker XL',                brand = 'Dundreary',       price = 80000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'novak',         name = 'Novak',                         brand = 'Lampadati',       price = 107000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'patriot',       name = 'Patriot',                       brand = 'Mammoth',         price = 110000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'patriot2',      name = 'Patriot Stretch',               brand = 'Mammoth',         price = 130000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'radi',          name = 'Radius',                        brand = 'Vapid',           price = 95000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'rebla',         name = 'Rebla GTS',                     brand = 'Übermacht',       price = 215000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'rocoto',        name = 'Rocoto',                        brand = 'Obey',            price = 130000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'seminole',      name = 'Seminole',                      brand = 'Canis',           price = 90000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'seminole2',     name = 'Seminole Frontier',             brand = 'Canis',           price = 110000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'serrano',       name = 'Serrano',                       brand = 'Benefactor',      price = 95000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'toros',         name = 'Toros',                         brand = 'Pegassi',         price = 255000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'xls',           name = 'XLS',                           brand = 'Benefactor',      price = 125000,   category = 'suvs',           type = 'automobile', shop = 'pdm' },
    ...
    --- Coupes (3)
    { model = 'cogcabrio',     name = 'Cognoscenti Cabrio',            brand = 'Enus',            price = 67000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'exemplar',      name = 'Exemplar',                      brand = 'Dewbauchee',      price = 91000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'f620',          name = 'F620',                          brand = 'Ocelot',          price = 40000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'felon',         name = 'Felon',                         brand = 'Lampadati',       price = 69000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'felon2',        name = 'Felon GT',                      brand = 'Lampadati',       price = 70000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'jackal',        name = 'Jackal',                        brand = 'Ocelot',          price = 79000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'oracle2',       name = 'Oracle XS',                     brand = 'Übermacht',       price = 60000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'sentinel',      name = 'Sentinel',                      brand = 'Übermacht',       price = 81000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'sentinel2',     name = 'Sentinel XS',                   brand = 'Übermacht',       price = 87000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'windsor',       name = 'Windsor',                       brand = 'Enus',            price = 120000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'windsor2',      name = 'Windsor Drop',                  brand = 'Enus',            price = 130000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'zion',          name = 'Zion',                          brand = 'Übermacht',       price = 70000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'zion2',         name = 'Zion Cabrio',                   brand = 'Übermacht',       price = 80000,   category = 'coupes',         type = 'automobile', shop = 'pdm' },
    { model = 'previon',       name = 'Previon',                       brand = 'Karin',           price = 150000,  category = 'coupes',         type = 'automobile', shop = 'pdm' },
