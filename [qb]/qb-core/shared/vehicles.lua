...
local Vehicles = {
   ...
   --[[  --- Off-Road (9)
    ...
    --- Custompdm
    { model = 'rmodx6',                  name = 'BMWx6',               brand = 'BMW',             price = 75000,   category = 'SUV',            type = 'automobile', shop = 'pdm' },
    ...
    { model = 'rmodcharger',            name = '2018 Dodge Charger',  brand = 'Dodge',           price = 62000,   category = 'Sport',          type = 'automobile', shop = 'pdm' },
    { model = 'kln',                    name = 'Rolls Cullinan',      brand = 'Rolls Royce',     price = 462000,  category = 'SUV',            type = 'automobile', shop = 'pdm' },
    ...
    { model = 'c8',                      name = 'Corvette C8',         brand = 'Chevrolet',       price = 130500,  category = 'Sport',          type = 'automobile', shop = 'pdm' },
    { model = 'audirs8',                 name = 'Audi Rs8',            brand = 'Audi',            price = 120550,  category = 'Super',          type = 'automobile', shop = 'pdm' },
    { model = 'autobio',                 name = 'Range Rover',         brand = 'Range Rover',     price = 80150,   category = 'SUV',            type = 'automobile', shop = 'pdm' },
    ...
    { model = '21rsq8',                 name = 'Audi Q8',           brand = 'Audi',            price = 126720 , category = 'SUV',            type = 'automobile', shop = 'pdm' },
    { model = '2022jeep',               name = '2022 Jeep',         brand = 'Jeep',            price = 52300 ,  category = 'offroad',        type = 'automobile', shop = 'pdm' },
    { model = '16topcargle',            name = '2011 AMG',           brand = 'Merecedes',       price = 40000 ,  category = 'SUV',            type = 'automobile', shop = 'pdm' },
    ...
    { model = '2ncsx7',                 name = '2020 WB X7',        brand = 'BMW',             price = 102000 , category = 'SUV',            type = 'automobile', shop = 'pdm' },
    { model = '20xb7',                  name = '2020 X7',           brand = 'BMW',             price = 91000 ,  category = 'SUV',            type = 'automobile', shop = 'pdm' },
    ...
    { model = 'abhawk',            name = '2018 WB Trackhawk', brand = 'Jeep',            price = 144000 , category = 'SUV',            type = 'automobile', shop = 'pdm' },
    ...
    { model = 'charger21',          name = '2021 SRT',          brand = 'Dodge',           price = 78599 ,  category = 'Sport',          type = 'automobile', shop = 'pdm' },
    { model = 'gt63mt',             name = 'AMG GT63',          brand = 'Merecedes',       price = 148999 , category = 'Sport',          type = 'automobile', shop = 'pdm' },
    { model = 'p1lbwk',              name = 'P1',                brand = 'Mclaren',         price = 1258399 ,category = 'Super',          type = 'automobile', shop = 'pdm' },
    { model = 'rx7veilside',           name = 'rx7veilside',       brand = 'Mazda',           price = 58329 ,  category = 'Sport',          type = 'automobile', shop = 'pdm' },
    ...
    { model = 'machewb',                name = 'E Mach',            brand = 'Ford',            price = 105829 , category = 'SUV',            type = 'automobile', shop = 'pdm' },
    { model = 'gtr50',                  name = '2023 GTR',          brand = 'Nissan',          price = 122970 , category = 'Sport',          type = 'automobile', shop = 'pdm' },
