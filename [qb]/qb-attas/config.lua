...
WeaponAttachments = {
    ...
    clip_attachment = {
        weapon_anarchy = `w_ar_anarchy_mag2`,
        ...
        weapon_acwr = `w_ar_acwr_mag2`,
        weapon_fmr = `w_ar_fmr_mag2`,
        weapon_sb181 = `w_sb_sb181_mag2`,
        weapon_scarsc = `w_ar_scarsc_mag2`,
        ...
        weapon_nvifle_purple = `w_ar_nvrifle_purple_mag2`,
    ...
    suppressor_attachment = {
        weapon_anarchy = `w_at_ar_anarchy_supp`,
        ...
        weapon_acwr = `w_at_ar_acwr_supp`,
        weapon_fmr = `w_at_ar_fmr_supp`,
        weapon_sb181 = `w_at_sb_sb181_supp`,
        weapon_scarsc = `w_at_ar_scarsc_supp`,
        ...
        weapon_nvifle_purple = `w_at_nvrifle_purple_supp`,
    ...
    smallscope_attachment = {
        ...
        weapon_nvifle_purple = `w_at_nvrifle_purple_scope_small`,
    ...
    medscope_attachment = {
        ...
        weapon_neva = `w_at_ar_neva_scope`,
        weapon_bas_p_red = `w_at_bas_p_scope`,
        weapon_art64 = `w_at_ar_art64_scope`,
        weapon_acwr = `w_at_ar_acwr_scope`,
    ...
    holoscope_attachment = {
        ...
        weapon_nvifle_purple = `w_at_nvrifle_purple_scope_sight`,
    },
    advscope_attachment = {
    ...
    grip_attachment = {
        weapon_anarchy = `w_at_ar_anarchy_grip`,
        ...
        weapon_acwr = `w_at_ar_acwr_grip`,
        weapon_fmr = `w_at_ar_fmr_grip`,
        weapon_scarsc = `w_at_ar_scarsc_grip`,
        weapon_m4_tactical_red = `w_at_m4_tactical_red_supp`,
        weapon_m4asiimov = `w_at_m4_asiimov_grip`,
        weapon_m47v2 = `w_at_ar_m47v2_grip`,

        weapon_nvifle_purple = `w_at_nvrifle_purple_afgrip`,
