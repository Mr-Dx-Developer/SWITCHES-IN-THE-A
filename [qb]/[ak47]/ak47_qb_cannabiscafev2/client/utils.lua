...
RegisterNetEvent('ak47_qb_cannabiscafev2:notify')
AddEventHandler('ak47_qb_cannabiscafev2:notify', function(msg)
    QBCore.Functions.Notify(msg)
end)

RegisterNetEvent('ak47_qb_cannabiscafev2:progress')
AddEventHandler('ak47_qb_cannabiscafev2:progress', function(msg, time)
