dwConfig.Shop['taco'] = { -- job name
	blip = {enable = true, name = 'Taco', sprite = 277, color = 0, size = 1.0, radius = 0.0, radius_color = 4},
	...
	crafting = {
		menu = vector3(13.160440444946289,-1602.5670166015625,29.3809814453125),
		data = {
