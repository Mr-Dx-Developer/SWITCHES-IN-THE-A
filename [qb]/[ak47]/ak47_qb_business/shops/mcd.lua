Config.Shop['mcdonalds'] = { -- job name
	blip = {enable = true, name = 'McDonalds', sprite = 278, color = 0, size = 0.6, radius = 0.0, radius_color = 4},
	boss_action = vector3(84.14505767822266,293.80218505859375,110.192626953125),
	management = vector3(85.63516998291016,292.3121032714844,110.192626953125),
	managementRankFor = {
		price = 2,
		stock = 2,
	},
	...
	crafting = {
		menu = vector3(96.64615631103516,293.8417663574219,110.192626953125),
		data = {
			big_mac = { 										-- reward item name
				...
				steps = {
					{pos = vector4(95.45934295654297, 294.21099853515625, 110.192626953125, 342.99212646484375),  delay = 20, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(92.87472534179688, 295.1604309082031, 110.192626953125, 334.4881896972656),  delay = 20, msg = 'Working...'},	-- x, y, z, heading, second, message
					{pos = vector4(95.88131713867188, 292.3516540527344, 110.192626953125, 238.1102294921875),  delay = 30, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
			...
			hot_fudge_sundae = { 										-- reward item name
				...
				steps = {
					{pos = vector4(94.86593627929688,289.5296630859375, 110.192626953125, 255.11810302734375),  delay = 5, msg = 'Working...'},	-- x, y, z, heading, second, message
				}
			},
	...
	storage = {
		pos = vector4(-217.3817, -1315.1775, 31.4522, 95.8691), 		-- x, y, z, heading
		prop = nil,
		items = {
			world_famous_fries = {
	...
	sell_coords = {											-- The coordinates where customes will buy things on this store (coordinates composed of x, y, z)
		vector3(87.78462219238281,283.4901123046875,110.192626953125),
		vector3(88.65495300292969,285.78460693359375,110.192626953125),
		vector3(89.56483459472656,288.1318664550781,110.192626953125),
		--vector3(-215.3813, -1322.0232, 31.4522),
		vector3(88.32527923583984,289.8329772949219,110.192626953125)
