...
Config.ImpoundLocations = { -- IMPORTANT - Every impound name must be unique
  ['Impound A'] = {
    coords = vector3(688.6153564453125,234.56703186035156,93.3092041015625),
    spawn = vector4(675.8241577148438,245.84176635742188,93.89892578125,334.4881896972656),
    distance = 15,
    type = "car",
    blip = {
      id = 68,
